...
def tilt_shift(im, dof=60, enhance=True, focus_height=None, focus_height_per=None):
    ...
    above_focus, below_focus = im[:focus_height,:], im[focus_height:,:] # splits img into above and below focus
    above_focus = increasing_blur(above_focus[::-1,...], dof)[::-1,...] # adds blur onto each of them
...
if __name__ == '__main__':
    ...
    # group.add_argument("-imo", help="Path to image")
